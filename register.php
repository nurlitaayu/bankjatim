...
$query-> bindParam(':role', $gender, PDO::PARAM_STR);
					...
					<div class="col-md-12">
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <label class="col-sm-1 control-label">NIP<span style="color:red">*</span></label>
                            <div class="col-sm-5">
                            ...
                            <label class="col-sm-1 control-label">Alamat<span style="color:red">*</span></label>
                            <div class="col-sm-5">

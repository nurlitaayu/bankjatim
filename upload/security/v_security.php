...
// Fetch categories
$cQuery = "SELECT * FROM categories WHERE work_unit = 4";
                                ...
                                <div class="col-md-8">
                                    <div class="list-group">
                                        <?php foreach ($files as $key => $file) { ?>
                                            <a target="_blank" href="viewpdf.php?path=<?= HTTP_SERVER . 'upload/uploads/security/' . $file['doc_path'] ?>" class="list-group-item list-group-item-action">
